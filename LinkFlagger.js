...
window.addEventListener("load", function () {
    ...
    function swspoilers() {
        $(document.querySelector("h1[class*='d2l-login-portal-heading']")).html('<h1 style="font-size: 24px; text-align: center; color: #ff0000"><span style="font-weight:bold">"OMG, like I-Learn 3 is just the worse.... I-Learn 2 was perfect!!!!"</span></h1><br><img width="100%" src="http://i.imgur.com/UlQYs6T.gif">');
    }
});
