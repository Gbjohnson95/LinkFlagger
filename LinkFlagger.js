...
var iframes_cached_value = iframes;
var ciframe;

function checkForIframes() {

	if (iframes == 1) {
		ciframe = document.querySelectorAll("iframe");
		if (ciframe.length > 0) {
...
function hypnotoad() {
	...
	$("h1[class*='d2l-login-portal-heading']").css({
		"font-weight" : "bold",
		"color" : "#000000",
		"font-size" : "75px",
		"text-align" : "center"
